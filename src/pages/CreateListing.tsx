...
import { Loader2, Home, DollarSign, MapPin, Bed, Users, Star, X } from "lucide-react";
...
export default function CreateListing() {
  ...
  const handleSaveListing = async () => {
    try {
      ...
      // Navigate to upload photos or dashboard
      navigate(`/dashboard`);
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Create Room Listing</h1>
          <p className="text-muted-foreground">Fill in the details about your room</p>
        </div>
