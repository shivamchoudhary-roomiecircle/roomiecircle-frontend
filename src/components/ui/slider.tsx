...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    {/* Fallback for defaultValue or empty value if needed, though usually controlled value is best. 
        Radix slider needs thumbs to correspond to values. 
        If just one value or undefined, one thumb. 
    */}
